...
if [ $ROOT ]; then
	apt-get update &&
	apt-get install aptitude bash-completion bc boxes bsdmainutils ccze checkinstall colordiff colormake coreutils curl dnsutils findutils git htop lynx mlocate moreutils most net-tools openssl procps pv tar tcpflow traceroute tree unzip vim wget
