...
if [ $ROOT ]; then
	apt-get update &&
	apt-get install aptitude bash-completion bc boxes bsdmainutils ccze checkinstall colordiff colormake coreutils curl findutils git htop lynx mlocate moreutils most net-tools openssl procps pv tar tcpflow unzip vim wget
